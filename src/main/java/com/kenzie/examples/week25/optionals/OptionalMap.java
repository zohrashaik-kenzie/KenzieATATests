...
public class OptionalMap {
    public static void main(String[] args) {
        Optional<Optional>  nonEmptyOptional = Optional.of(Optional.of("SEBD Advanced ATA Term 4"));
         ...
         */
        /*----------------------------------------------------------*/
        Function<String, String> function = s -> s.substring(0, 1).length() == 1 ? null : s;

       // System.out.println(nonEmptyOptional.map(optional.map(function));
